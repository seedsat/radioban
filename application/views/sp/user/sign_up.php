<div id="page-wrapper">
    ...
    <div class="form">
        <a href="#twitterbutton"><p style="text-align:center; text-decoration:underline; color:red;">Twitterで会員登録をする人は<br />下のボタンからお願いします。</p></a>
    </div><!-- form -->
    <div class="form">
        <form method="post" action="<?php echo base_url('signup'); ?>">
            <div class="sp-form-item">
                <span style="color:red;"><?php echo form_error('username'); ?></span>
                <input type="text" name="username" placeholder="ラジオネーム" value="<?php echo set_value('username'); ?>"></input>
            </div>
            <div class="sp-form-item">
            ...
            <div class="kiyaku">
                <h3>利用規約</h3>
                <p>この利用規約（以下，「本規約」といいます。）は，ラジボド（以下，「当サイト」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。</p>
                ...
                <ol>
                <li>当サイトは原則無料にてご利用頂けますが、規約違反を犯した場合は</li>
            ...
            <div class="form-item">
                ...
                <?php if(isset($error)): ?><p style="color:red; text-align:center; margin-top:5px;"><?php echo $error; ?></p><?php endif;?>
                <h5 style="text-align:center;"><label><input type="checkbox" name="kiyaku" value="1">利用規約の同意する</label></h5>
            </div>
            <div class="sp-button-panel">
                <input type="submit" class="button-pink" value="会員登録する"></input>
            </div>
        </form>
    </div><!-- form -->
