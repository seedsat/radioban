    ...
    <div class="signup-wrapper">
      ...
      <form action="<?php echo current_url(''); ?>" method="post" >
        <div class="form-item">
          ...
          <input type="text" name="user_name" placeholder="ラジオネーム" value="<?php echo set_value('user_name'); ?>"></input>
        </div>
        <div class="form-item">
          <span style="color:red;"><?php echo form_error('user_email'); ?></span>
          <input type="text" name="user_email" placeholder="メールアドレス" value="<?php echo set_value('user_email'); ?>"></input>
        </div>
        <div class="form-item">
          <span style="color:red;"><?php echo form_error('user_password'); ?></span>
          <input type="password" id="password" name="user_password" placeholder="パスワード"  value="<?php echo set_value('user_password'); ?>"></input>
        ...
        <div class="button-panel">
          <input type="submit" class="button" value="会員登録する"></input>
        </div>
      </form>
    </div>
  </div>
