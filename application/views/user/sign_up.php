        ...
        <div class="signup-wrapper">
            ...
            <form action="<?php echo current_url(''); ?>" method="post" >
                <div class="form-item">
                    ...
                    <input type="text" name="name" placeholder="ラジオネーム" value="<?php echo set_value('name'); ?>"></input>
                </div>
                <div class="form-item">
                    <span style="color:red;"><?php echo form_error('email'); ?></span>
                    <input type="text" name="email" placeholder="メールアドレス" value="<?php echo set_value('email'); ?>"></input>
                </div>
                <div class="form-item">
                    <span style="color:red;"><?php echo form_error('password'); ?></span>
                    <input type="password" id="password" name="password" placeholder="パスワード"></input>
